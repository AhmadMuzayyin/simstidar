              ...
              <table class="table table-head-fixed text-nowrap table-hover">              
                  ...
                  <tbody class="text-center">
                    ...
                    <tr>
                      ...
                      <td><?= $value['prodi'] ?></td>
                      <td><?= $value['jenjang'] ?></td>
                      <td><small class="loat-right badge bg-teal"><?= $jml ?></small></td>
                      <td>
                          <a href="<?= base_url('matkul/detail_matkul/'. $value['id_prodi']) ?>" class="btn bg-teal btn-xs"><i class="fas fa-th-list"></i> Mata Kuliah</a>
                      </td>
                    </tr>
                        <?php } ?>
