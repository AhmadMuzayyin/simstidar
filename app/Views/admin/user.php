          ...
          <div class="card-body table-responsive">
              <table id="example1"class="table table-hover">              
                  ...
                  <tbody>
                    ...
                    <tr class="text-center">
                      <td><?= $no++; ?></td>
                      <td><img src="foto/<?= $value['foto_user'] ?>" class="img-circle" width="40px" height="40px" alt="User Image"></td>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="form-group col-sm-8">
                  <label>Foto User</label>
                  <input type="file" name="foto_user" id="preview_gambar" class="form-control">
                </div>
                <div class="form-group col-sm-4 text-center">
                  <img src="<?= base_url('foto/' . $value['foto_user'])?>" id="gambar_load" class="img-circle" width="100px" height="100px" alt="User Image">
                </div>
              </div>
